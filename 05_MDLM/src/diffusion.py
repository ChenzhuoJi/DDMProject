  ...
  def _sample(self, num_steps=None, eps=1e-5, ret_snapshots=False):
    ...
    if ret_snapshots:
      snapshot_t_values = [
        ...
        0.15, 0.12, 0.10, 0.08, 0.06, 0.04, 0.02, 0.01, 0.005, 0.0
      ]
